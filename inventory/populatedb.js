...
async function createGoggles() {
  ...
  await Promise.all([
    ...
    goggleCreate("4D MAG", "Check your zippers and buckle your boots. It's time to drop in. The Smith 4D MAG™ brings our widest field of view and sharpest optics to give you the best possible read on the terrain, so you can nail your line every time. Add our quick and easy lens-change tech, and you've got the only goggle you need for all-conditions riding. Thanks to ChromaPop™, the 4D MAG™ drops you into a bigger, brighter, sharper world.", 320, brands[2], categories[2], [tags[0], tags[1], tags[2]]),
...
async function createGoggleInstances() {
  ...
  await Promise.all([
    goggleInstanceCreate(goggles[0], {style: "Vivid Ember and Vivid Infared", detail: "With two lenses included, you're covered for mixed sun/cloud conditions along with overcast/storm conditions"}, 42),
    goggleInstanceCreate(goggles[0], {style: "Vivid Pink and Vivid Apex", detail: "With two lenses included, you're covered for mixed sun/cloud conditions along with overcast/storm conditions"}, 27),
    goggleInstanceCreate(goggles[0], {style: "Vivid Smoke and Vivid Infared", detail: "With two lenses included, you're covered for full sun conditions along with overcast/storm conditions"}, 19),
    goggleInstanceCreate(goggles[1], {style: "Vivid Royal and Vivid Infared", detail: "With two lenses included, you're covered for mixed sun/cloud conditions along with overcast/storm conditions"}, 38),
    goggleInstanceCreate(goggles[1], {style: "Vivid Onyx and Vivid Infared", detail: "With two lenses included, you're covered for full sun conditions along with overcast/storm conditions"}, 22),
    goggleInstanceCreate(goggles[1], {style: "Vivid Emerald and Vivid Apex", detail: "With two lenses included, you're covered for mixed sun/cloud conditions along with overcast/storm conditions"}, 26),
    goggleInstanceCreate(goggles[2], {style: "Grey Cobalt", detail: "Optimal for mixed sun/cloud conditions"}, 12),
    goggleInstanceCreate(goggles[2], {style: "Amber Rose", detail: "Optimal for overcast/stormy conditions"}, 16),
    goggleInstanceCreate(goggles[2], {style: "Amber Scarlet", detail: "Optimal for mixed sun/cloud and mostly cloudy conditions"}, 31),
    goggleInstanceCreate(goggles[3], {style: "Ignitor Mirror", detail: "Optimal in mixed sun/cloud and mostly sunny conditions"}, 24),
    goggleInstanceCreate(goggles[3], {style: "Blue Sensor Mirror", detail: "Optimal in mostly cloudy and overcast/stormy conditions"}, 38),
    goggleInstanceCreate(goggles[3], {style: "Clear", detail: "Optimal in overcast/stormy conditions"}, 13),
    goggleInstanceCreate(goggles[4], {style: "Rose Gold", detail: "Optimal in mixed sun/cloud and mostly cloudy conditions"}, 64),
    goggleInstanceCreate(goggles[4], {style: "Everyday Green", detail: "Optimal in mixed sun/cloud conditions"}, 42),
    goggleInstanceCreate(goggles[4], {style: "Storm Rose", detail: "Optimal in mostly cloudy and overcast/stormy conditions"}, 51),
    goggleInstanceCreate(goggles[5], {style: "Everyday Red and Storm Yellow", detail: "With two lenses included, you're covered for mixed sun/cloud conditions along with overcast/stormy conditions"}, 48),
    goggleInstanceCreate(goggles[5], {style: "Sun Black and Blue Sensor Mirror", detail: "With two lenses included, you're covered for full sun conditions along with overcast/stormy conditions"}, 37),
    goggleInstanceCreate(goggles[5], {style: "Red Mirror and Storm Rose Flash", detail: "With two lenses included, you're covered for mixed sun/cloud conditions along with overcast/stormy conditions"}, 59),
    goggleInstanceCreate(goggles[6], {style: "Sapphire Iridium", detail: "Optimal in sunny and mixed sun/cloud conditions"}, 71),
    goggleInstanceCreate(goggles[6], {style: "Torch Iridium", detail: "Optimal in sunny and mixed sun/cloud conditions"}, 61),
    goggleInstanceCreate(goggles[6], {style: "Hi Pink Iridium", detail: "Optimal in mostly cloudy and overcast/stormy conditions"}, 21),
    goggleInstanceCreate(goggles[7], {style: "Black Iridium", detail: "Optimal in full sun and mixed sun/cloud conditions"}, 43),
    goggleInstanceCreate(goggles[7], {style: "Rose", detail: "Optimal in mixed sun/cloud and overcast/stormy conditions"}, 63),
    goggleInstanceCreate(goggles[7], {style: "Jade Iridium", detail: "Optimal in sunny and mixed sun/cloud conditions"}, 18),
    goggleInstanceCreate(goggles[8], {style: "Persimmon", detail: "Optimal in overcast/stormy conditions"}, 64),
    goggleInstanceCreate(goggles[8], {style: "Sapphire Iridium", detail: "Optimal in sunny and mixed sun/cloud conditions"}, 47),
    goggleInstanceCreate(goggles[8], {style: "Gold Iridium", detail: "Optimal in sunny and mixed sun/cloud conditions"}, 32),
  ])
}
